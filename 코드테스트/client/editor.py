...
class PythonEditor:
        ...
        def get_user_code(self, is_correct=False):
            if is_correct:
                try:
                    if self.popup_code_correct.popup.winfo_exists():
                        return
                except Exception as ex:
                        pass
                self.popup_code_correct = PopupCode(self,is_correct)
            else:
                try:
                    if self.popup_code.popup.winfo_exists():
                        return
                except Exception as ex:
                        pass
                self.popup_code = PopupCode(self,is_correct)
